...
if __name__=='__main__':
    ...
    patch_obj = Patches(
        img_patch_h=224, img_patch_w=224,
        stride_h=120, stride_w=120,
        label_patch_h=224, label_patch_w=224)

    data = patch_obj.extract_patches(data)
    mask = patch_obj.extract_patches(mask) #output:[num_patch, w,h,c], padding with symmetric