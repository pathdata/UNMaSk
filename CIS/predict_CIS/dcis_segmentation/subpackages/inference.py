...
def inception_block(in_tensor, in_feat_dim, out_feat_dim, is_batch_norm, layer_name, strides=None, padding='SAME'):
    conv1_1 = convolution_2d_full(in_tensor=in_tensor, in_ch_dim=in_feat_dim, out_ch_dim=out_feat_dim,
                                  is_batch_norm=is_batch_norm, layer_name=layer_name + '_Convolution_1_1',
                                  kdim1=3, kdim2=3, strides=strides, padding=padding)
    r_conv1_1 = activation(conv1_1)
    conv2_1 = convolution_2d_full(in_tensor=r_conv1_1, in_ch_dim=out_feat_dim, out_ch_dim=out_feat_dim,
                                  is_batch_norm=False, layer_name=layer_name + '_Convolution_2_1',
                                  kdim1=3, kdim2=3, strides=strides, padding=padding)
    r_conv2_1 = activation(conv2_1)

    conv1_2 = convolution_2d_full(in_tensor=in_tensor, in_ch_dim=in_feat_dim, out_ch_dim=out_feat_dim,
                                  is_batch_norm=is_batch_norm, layer_name=layer_name + '_Convolution_1_2',
                                  kdim1=1, kdim2=1, strides=strides, padding=padding)
    r_conv1_2 = activation(conv1_2)
    conv2_2 = convolution_2d_full(in_tensor=r_conv1_2, in_ch_dim=out_feat_dim, out_ch_dim=out_feat_dim,
                                  is_batch_norm=False, layer_name=layer_name + '_Convolution_2_2',
                                  kdim1=3, kdim2=3, strides=strides, padding=padding)
    r_conv2_2 = activation(conv2_2)

    pool1 = tf.nn.avg_pool(in_tensor, ksize=[1, 3, 3, 1], strides=[1, 1, 1, 1], padding=padding)
    conv3_1 = convolution_2d_full(in_tensor=pool1, in_ch_dim=in_feat_dim, out_ch_dim=out_feat_dim,
                                  is_batch_norm=False, layer_name=layer_name + '_Convolution_3_1',
                                  kdim1=3, kdim2=3, strides=strides, padding=padding)
    r_conv3_1 = activation(conv3_1)

    conv4_1 = convolution_2d_full(in_tensor=in_tensor, in_ch_dim=in_feat_dim, out_ch_dim=out_feat_dim,
                                  is_batch_norm=False, layer_name=layer_name + '_Convolution_4_1',
                                  kdim1=3, kdim2=3, strides=strides, padding=padding)
    r_conv4_1 = activation(conv4_1)

    output = tf.concat(values=[r_conv2_1, r_conv2_2, r_conv3_1, r_conv4_1], axis=3)
...
def inference(network, is_training, images=None):
    ...
    with tf.name_scope(name):
        incept_1 = inception_block(in_tensor=images, in_feat_dim=in_feat_dim, out_feat_dim=out_conv_dim,
                                   is_batch_norm=True, layer_name=name + '_incept_1')

        conv1_1 = convolution_2d_full(incept_1, out_conv_dim*4, out_conv_dim, False, name + '_Convolution_1',
                                      kdim1=3, kdim2=3)
        r_conv1_1 = activation(conv1_1)
        ...
        incept_2 = inception_block(in_tensor=imrsize1_1, in_feat_dim=in_feat_dim, out_feat_dim=out_conv_dim,
                                   is_batch_norm=True, layer_name=name + '_incept_2')
        conv1_3 = convolution_2d_full(incept_2, out_conv_dim*4, out_conv_dim, True, name + '_Convolution_3',
                                      kdim1=3, kdim2=3)
    ...
    with tf.name_scope(name):
        incept_3 = inception_block(in_tensor=b1, in_feat_dim=in_ch_dim, out_feat_dim=out_conv_dim,
                                   is_batch_norm=False, layer_name=name + '_incept_3')
        
        conv2_1 = convolution_2d_full(incept_3, out_conv_dim*4, out_conv_dim, False, name + '_Convolution_1', kdim1=3, kdim2=3)
        r_conv2_1 = activation(conv2_1)
        ...
        incept_4 = inception_block(imrsize2_1,in_feat_dim=in_feat_dim, out_feat_dim=out_conv_dim,
                                   is_batch_norm=True, layer_name=name + '_incept_4')
        
        conv2_3 = convolution_2d_full(incept_4, out_conv_dim*4, out_conv_dim, True, name + '_Convolution_3',
                                      kdim1=3, kdim2=3)
    ...
    with tf.name_scope(name):
        ...
        incept_5 = inception_block(in_tensor=b2, in_feat_dim=in_ch_dim, out_feat_dim=out_conv_dim,
                                   is_batch_norm=False, layer_name=name + '_incept_5')
        
        conv3_1 = convolution_2d_full(incept_5, out_conv_dim*4, out_conv_dim, False, name + '_Convolution_1', kdim1=3, kdim2=3)
        r_conv3_1 = activation(conv3_1)
        ...
        incept_6 = inception_block(imrsize3_1,in_feat_dim=in_feat_dim, out_feat_dim=out_conv_dim,
                                   is_batch_norm=True, layer_name=name + '_incept_6')
        conv3_3 = convolution_2d_full(incept_6,  out_conv_dim*4, out_conv_dim, True, name + '_Convolution_3',
                                      kdim1=3, kdim2=3)
    ...
    with tf.name_scope(name):
        ...
        incept_7 = inception_block(in_tensor=b3, in_feat_dim=in_ch_dim, out_feat_dim=out_conv_dim,
                                   is_batch_norm=False, layer_name=name + '_incept_7')
        
        conv4_1 = convolution_2d_full(incept_7, out_conv_dim*4, out_conv_dim, False, name + '_Convolution_1', kdim1=3, kdim2=3)
        r_conv4_1 = activation(conv4_1)
        ...
        incept_8 = inception_block(imrsize4_1, in_feat_dim=in_feat_dim, out_feat_dim=out_conv_dim,
                                   is_batch_norm=True, layer_name=name + '_incept_8')
        conv4_3 = convolution_2d_full(incept_8, out_conv_dim*4, out_conv_dim, True, name + '_Convolution_3',
                                      kdim1=3, kdim2=3)
...
#        incept_9 = inception_block(in_tensor=b4, in_feat_dim=in_ch_dim, out_feat_dim=out_conv_dim,
#                                   is_batch_norm=False, layer_name=name + '_incept_9')
