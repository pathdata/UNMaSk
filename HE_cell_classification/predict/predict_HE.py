...
#CMD python predict_HE.py -exp_dir $exp_dir -data_dir $data_dir -results_dir $results_dir -detection_results_path $detection_results_path -tissue_segment_dir $tissue_segment_dir -file_name_pattern $file_name_pattern -cluster $cluster

###################################################################################################

opts = get_parsed_arguments()
...
if opts.cluster:
    ...
    opts = NetworkOptions.NetworkOptions(exp_dir=r'ExpDir-TA-Duke',
