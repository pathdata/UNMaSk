...
% if ~exist(fullfile(results_dir, 'class_csv', sub_dir_name), 'dir')
%     mkdir(fullfile(results_dir, 'class_csv', sub_dir_name));
% end
...
%             end
        ...
        writetable(A, fullfile(results_dir, 'class_csv', sub_dir_name, [mat_file_name(1:end-3), 'csv']));
    else
        fileID = fopen(fullfile(results_dir, 'class_csv', sub_dir_name, [mat_file_name(1:end-3), 'csv']), 'w');
